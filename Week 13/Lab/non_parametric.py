...
class DTN:
    N_THRESHOLD = 5 # don't split if node has fewer examples than this
    H_THRESHOLD = 0 # don't split if node has entropy less than this
    H_REDUCTION_THRESHOLD = 0 # don't split if it doesn't reduce H by this
    index = 0
