...
# Analyze auto data
#-------------------------------------------------------------------------------     
#print(hw5.ridge_min(auto_data[0],auto_values,0))
...
for order in range(1,4):
    if order == 3:
        ...
        lambdas = lambdas1
    for lam in lambdas:
        print('ord=',order,' lam=',lam,' RMSE=',hw5.xval_learning_alg(hw5.make_polynomial_feature_fun(order)(auto_data[0]), auto_values, lam, 10)*sigma)
#for feature set 2
print('-------------------------')
for order in range(1,4):
    if order == 3:
        ...
        lambdas = lambdas1
    for lam in lambdas:
        print('ord=',order,' lam=',lam,' RMSE=',hw5.xval_learning_alg(hw5.make_polynomial_feature_fun(order)(auto_data[1]), auto_values, lam, 10)*sigma)
#print(hw5.xval_learning_alg(hw5.make_polynomial_feature_fun(1)(auto_data[0]), auto_values, 0.02, 10)*sigma)
